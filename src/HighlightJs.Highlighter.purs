module HighlightJs.Highlighter
  ( HLJS
  , make
  , registerLanguage
  , highlight
...
registerLanguage
  ...
  -> HLJS
  -> Effect Unit
registerLanguage = registerLanguage_
  { languageAliasString: \(LanguageAlias s) -> s }

foreign import highlight_
  :: { left :: ∀ l r. l -> Either l r

module Kwap.Style.Global (stylesheet) where

import Prelude

import Halogen.HTML (HTML)
import Halogen.HTML.CSS as HalogenCss
import Kwap.Css.Font.Style as Font.Style
import Kwap.Navbar.Button.Style as Navbar.Button.Style
...
--
-- **All** CSS selections must use the Kwap.Css.definedIn rule, so that
